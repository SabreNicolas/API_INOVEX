...
describe("ImportTonnageSortantService", () => {
  let service: ImportTonnageSortantService;
  ...
  beforeEach(async () => {
    ...
    service = module.get<ImportTonnageSortantService>(
      ImportTonnageSortantService
    );
    jest.clearAllMocks();
  });
  ...
  describe("create", () => {
    it("should create import tonnage sortant", async () => {
      mockRepository.save.mockResolvedValue({ id: 1, productImport: "PI" });
